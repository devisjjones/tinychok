...
- вложения в сообщениях считаются disposable-storage, а не вечным файлообменником:
  ...
  - сообщение / комментарий / пост при этом не удаляется целиком, а получает viewer-aware заметку:
    - владелец видит `Вложение удалено автоматически, потому что в вашем хранилище закончилось место.`
    - собеседник видит `Вложение удалено автоматически, потому что у собеседника закончилось место в хранилище.`
