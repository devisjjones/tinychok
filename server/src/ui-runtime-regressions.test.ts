...
test('quiet settings scene keeps category-specific notification contract wired through app, shared types and docs', () => {
  ...
  assert.match(appCss, /\.settings-checkbox input\[type='checkbox'\]\s*\{[\s\S]*appearance:\s*none;[\s\S]*border-radius:\s*11px;[\s\S]*background-size:\s*13px 10px;/u)
  assert.match(appCss, /\.settings-checkbox input\[type='checkbox'\]:checked\s*\{[\s\S]*background-image:\s*url\("data:image\/svg\+xml,/u)
  ...
  assert.match(appCss, /html\[data-theme='dark'\] \.settings-checkbox input\[type='checkbox'\]:checked\s*\{[\s\S]*background-color:\s*#a45b4e;/u)
...
test('dark theme toggle persists in session snapshots and ships a gray dark-surface contract', async () => {
  ...
  assert.match(appCss, /html\[data-theme='dark'\] \.settings-checkbox input\[type='checkbox'\]:checked\s*\{[\s\S]*border-color:\s*#a45b4e;[\s\S]*background-color:\s*#a45b4e;/u)
